...
namespace EP_HSRlearnIT.BusinessLayer.Testing.AesGcmLibraryTest
{
    ...
    public class AuthenticatedAesCngGcmTestVectorTest
    {
        ...
        private static readonly GcmTestVector[] STestVectors = new GcmTestVector[]
        {
            // Test Case 1
            new GcmTestVector
            {
        ...
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector1() { RunTestVector(STestVectors[0]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector2() { RunTestVector(STestVectors[1]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector3() { RunTestVector(STestVectors[2]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector4() { RunTestVector(STestVectors[3]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector7() { RunTestVector(STestVectors[6]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector8() { RunTestVector(STestVectors[7]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector9() { RunTestVector(STestVectors[8]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector10() { RunTestVector(STestVectors[9]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector13() { RunTestVector(STestVectors[12]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector14() { RunTestVector(STestVectors[13]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector15() { RunTestVector(STestVectors[14]); }
        [TestMethod]
        public void AuthenticatedAesCngGcmTestVector16() { RunTestVector(STestVectors[15]); }
        ...
        public void AuthenticatedAesCngGcmTestVector5() { RunTestVector(STestVectors[4]); }
        [TestMethod, ExpectedException(typeof(CryptographicException))]
        public void AuthenticatedAesCngGcmTestVector6() { RunTestVector(STestVectors[5]); }
        [TestMethod, ExpectedException(typeof(CryptographicException))]
        public void AuthenticatedAesCngGcmTestVector11() { RunTestVector(STestVectors[10]); }
        [TestMethod, ExpectedException(typeof(CryptographicException))]
        public void AuthenticatedAesCngGcmTestVector12() { RunTestVector(STestVectors[11]); }
        [TestMethod, ExpectedException(typeof(CryptographicException))]
        public void AuthenticatedAesCngGcmTestVector17() { RunTestVector(STestVectors[16]); }
        [TestMethod, ExpectedException(typeof(CryptographicException))]
        public void AuthenticatedAesCngGcmTestVector18() { RunTestVector(STestVectors[17]); }
