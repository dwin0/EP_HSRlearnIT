...
namespace EP_HSRlearnIT.BusinessLayer.Testing.UniversalToolsTest
{
    ...
    public class FileSaverTests
    {
        ...
        {
            FileSaver.CreateFile(@"c:\temp\HSRlearnIT\Test", "AES-GCM.txt");
        ...
        {
            string file = FileSaver.CreateFile(@"c:\temp\HSRlearnIT\Test", "UpdateTest.txt");
        ...
        {
            string file = FileSaver.CreateFile(@"c:\temp\HSRlearnIT\Test", "AddTest.txt");
